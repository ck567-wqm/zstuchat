    ...
    0: function (e, o, a) {
        ...
        var n = a("2b0e"), t = function () {
            ...
            m = Object(r["a"])(s, t, i, !1, null, null, null), u = m.exports, l = a("8c4f"), g = function () {
                ...
                mounted: function () {
                    this.joinRoom = this.$store.state.joinRoom, this.emojiList = S
                },
                watch: {
                    message: function (e) {
                        this.handleMessageBox(e)
            ...
            }, v = b, F = (a("15b2"), Object(r["a"])(v, p, h, !1, null, "7f15ea7f", null)), w = F.exports, j = a("8055"),
            k = a.n(j), C = {
                name: "Login", components: {Room: w}, data: function () {
                    ...
                    var e = this;
                    this.socket = k()(Object({
                        NODE_ENV: "production",
                        BASE_URL: "/chatroom/"
                    }).VUE_APP_URL || "/"), this.socket.on("userExit", (function (e) {
                        return alert(e.msg)
            ...
            }, _ = C, x = (a("dae2"), Object(r["a"])(_, g, f, !1, null, "b1697ca8", null)), O = x.exports;
        n["a"].use(l["a"]);
        var L = [{path: "/", name: "Login", component: O}], R = new l["a"]({routes: L}), $ = R, A = a("2f62");
        n["a"].use(A["a"]);
        var B = new A["a"].Store({
        ...
        n["a"].use(U.a, D), n["a"].use(U.a), new n["a"]({
            router: $, store: B, render: function (e) {
                return e(u)
            }
        }).$mount("#app")
    }, "61a8": function (e, o, a) {
...
//# sourceMappingURL=app.0abcd47a.js.map
