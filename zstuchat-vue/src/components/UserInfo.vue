  ...
  <div class="userinfo">
    <el-card>
      ...
      >
        ...
        <el-menu-item index="5">添加好友</el-menu-item>
        <el-menu-item index="6">发送消息</el-menu-item>
      </el-menu>
  ...
  methods: {
    ...
    getRoutePath() {
      ...
      if (path === "/userinfo/1") {
        ...
        this.activeIndex = "3";
      }else if (path === "/userinfo/4") {
        this.activeIndex = "4";
      }else if (path === "/userinfo/5") {
        this.activeIndex = "5";
      }else if (path === "/userinfo/6") {
        this.activeIndex = "6";
      }
    },
  },
